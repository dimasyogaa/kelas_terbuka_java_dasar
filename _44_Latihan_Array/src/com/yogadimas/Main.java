...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Sorting reverse, mengurutkan secara terbalik
        printArray(arrayAngka1, "array 1");
        reverse(arrayAngka1);
    ...
    private static void reverse2(int[] dataArray) {
        ...
        int buffer;
        // lebih cepat karena hanya looping setengah panjang arraynya
        for (int i = 0; i < dataArray.length / 2; i++) {
            buffer = dataArray[i];
            dataArray[i] = (dataArray.length - 1) - i;
    ...
    private static int[] tambahArray(int[] arrayInt1, int[] arrayInt2) {
        ...
        for (int i = 0; i < arrayInt1.length; i++) {
            // arrayInt1[i] = arrayInt1[i] + arrayInt2[i];
